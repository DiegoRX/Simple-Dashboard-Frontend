    ...
    <TableContainer component={Paper}>
      <Table className={classes.table} aria-label='simple table'>
        <TableHead className={classes.head}>
          <TableRow>
            <TableCell align='center' className={classes.cell}>Número Cotización</TableCell>
            <TableCell align='center' className={classes.cell}>Fecha de Cotización</TableCell>
            <TableCell align='center' className={classes.cell}>Cliente/Empresa</TableCell>
            <TableCell align='center' className={classes.cell}>Valor Cotización</TableCell>
