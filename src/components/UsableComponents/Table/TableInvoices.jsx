    ...
    <TableContainer component={Paper}>
      <Table className={classes.table} aria-label='simple table'>
        <TableHead className={classes.head}>
          <TableRow>
            <TableCell align='center' className={classes.cell}>Número Factura</TableCell>
            <TableCell align='center' className={classes.cell}>Fecha de Factura</TableCell>
            <TableCell align='center' className={classes.cell}>Cliente/Empresa</TableCell>
            <TableCell align='center' className={classes.cell}>Valor Factura</TableCell>
